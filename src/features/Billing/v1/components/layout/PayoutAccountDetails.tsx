...
export default function PayoutAccountDetails() {
  ...
  return (
    <div className="rounded-2xl border p-6" style={{ backgroundColor: "var(--cd-surface)", borderColor: "var(--cd-border-subtle)" }}>
      <h2 className="text-lg font-bold mb-1" style={{ color: "var(--cd-text)" }}>Payout Account Details</h2>
      <p className="text-sm mb-6" style={{ color: "var(--cd-text-muted)" }}>Receive funds and revenue securely to your bank account.</p>
      ...
      <div className="flex justify-end">
        <button
          ...
          className="cd-btn cd-btn-secondary px-6 py-2 rounded-xl text-sm font-semibold flex items-center gap-2"
        >
